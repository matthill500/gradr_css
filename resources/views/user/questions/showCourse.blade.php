                          ...
                          <table id="table-questions" class="table table-hover">
                            <tbody>
                                    ...
                                    <div class="content">
                                      ...
                                      <h7 style=""><a href="{{ route('user.answers.index', ['type' => $questionsCourse->getTable(), 'id' => $questionsCourse->id])}}" > {{$questionsCourse->answers}} Answer(s) </a></h7> <h7 class="float-right btn submit mButton"><a href="{{ route('user.answers.create', ['type' => $questionsCourse->getTable(), 'id' => $questionsCourse->id])}}">Answer</a></h7>
                                   </div>
                            </tbody>
                          </table>
                      </div>
